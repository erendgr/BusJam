...
namespace _Game._Dev.Scripts.Editor.LevelEditor
{
    ...
    public class LevelEditor_CustomEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            _gridConfigSo.ApplyModifiedProperties();
        ...
        private void DrawToolsSection()
        {
            ...
            if (_currentTool == EditorTool.AddCharacter)
                _selectedColor = (Colors)EditorGUILayout.EnumPopup("Character Color", _selectedColor);
        ...
        private void DrawLevelPropertiesSection(LevelEditor editor)
        {
            ...
            EditorGUILayout.PropertyField(_levelSo.FindProperty("LevelIndex"));
            EditorGUILayout.PropertyField(_levelSo.FindProperty("TimeLimitInSeconds"));

            SerializedProperty gridSizeProp = _levelSo.FindProperty("MainGridSize");
        ...
        private void DrawBusSettingsSection(LevelEditor editor)
        {
            ...
            EditorGUILayout.PropertyField(_levelSo.FindProperty("BusColorSequence"), true);
            EditorGUILayout.PropertyField(_levelSo.FindProperty("BusStopPosition"));
            EditorGUILayout.PropertyField(_levelSo.FindProperty("NextBusOffset"));
        ...
        private void DrawGridSettingsSection(LevelEditor editor)
        {
            ...
            EditorGUI.BeginChangeCheck();
            EditorGUILayout.PropertyField(_gridConfigSo.FindProperty("SpacingBetweenGrids"));
            if (EditorGUI.EndChangeCheck())
                editor.DisplayLevel();
        ...
        private Bounds CalculateGameplayBounds(LevelSO levelData, GridConfigurationSO gridConfig)
        {
        ...
        private void UpdateSerializedObjects()
        {
            ...
            _levelSo = editor.LevelToEdit != null ? new SerializedObject(editor.LevelToEdit) : null;
            _gridConfigSo = editor.GridConfig != null ? new SerializedObject(editor.GridConfig) : null;
        }
